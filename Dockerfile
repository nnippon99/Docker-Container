...
RUN mkdir /root/aosp.sata && mkdir /root/aosp.nvme && mkdir /root/aosp.nvme/Batuhantrkgl && mkdir /root/aosp.sata/Batuhantrkgl && mkdir /root/aosp.nvme/ItzKaguya && mkdir /root/aosp.sata/Itzkaguya
